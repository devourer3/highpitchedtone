...
public class Bbs_Write_API_Result { // retrofit2의 gsonconvert를 이용하기 위한 클래스.. JSON으로 전달하는 response 값을 Gson으로 필드에 매핑하기 위해서 필요하다.
    ...
    public Bbs_Write_API_Result(Boolean error, String message) {
        this.error = error;
